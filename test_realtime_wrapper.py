...
class WaypointCollector:
    ...
    def collect(self, waypoint):
        ...
        print(f"[WAYPOINT] Collected waypoint {waypoint.waypoint_index} at t={waypoint.timestamp:.3f}s - gesture_data shape: {waypoint.gesture_data.shape}")
...
def main():
    ...
    if hasattr(wrapper, 'last_generated_motion') and wrapper.last_generated_motion is not None:
        ...
        # Each waypoint contains gesture_data with shape (C,) - stack them
